...
def get_kafka_topic() -> str:
    ...
    topic = os.getenv("KAFKA_TOPIC", "golfing_topic")
...
def get_kafka_consumer_group_id() -> int:
    ...
    group_id: str = os.getenv("KAFKA_CONSUMER_GROUP_ID_JSON", "golfing_group")
...
def process_message(message: str) -> None:
    """
    Process golf related messages and log patterns
    ...
    if "drive" in message.lower():
        ...
        logger.info((f"Just another day on the links: {message}"))
